                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute left-1/2 top-0 bottom-0 w-0.5 vertical-line transform -translate-x-1/2 opacity-60" />
                            ...
                            <div className="space-y-16 relative">
                                {agendaSteps.map((step, index) => (
                                    ...
                                    >
                                        <div className={`circle-step relative flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'
                                            }`}>
                                            {/* Circle */}
                                            <div className="relative flex-shrink-0">
                                                ...
                                                <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-yellow-400 rounded-full transform -translate-x-1/2 -translate-y-1/2 shadow-md" />
                                            </div>

                                            {/* Text Content */}
                                            <div className={`mx-8 ${index % 2 === 0 ? 'text-left' : 'text-right'}`}>
                                                <div className={`bg-white rounded-xl p-6 shadow-lg border ${step.borderColor} max-w-sm ${index % 2 === 0 ? '' : 'ml-auto'
                                                    }`}>
