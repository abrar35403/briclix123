...
const ServiceCard: React.FC<{ service: typeof servicesData[0]; index: number }> = ({ service, index }) => {
    ...
    // Image-Only Card
    if (service.type === 'image-only') {
        return (
            <div
                ref={cardRef}
                className={`service-card ${service.span} relative overflow-hidden rounded-2xl border border-stone-800 bg-gradient-to-br from-stone-700 to-black group cursor-pointer ${isVisible ? 'animate-slide-up' : 'opacity-0'
                    }`}
                style={{
                    aspectRatio: '1 / 1',
                    minHeight: '180px',
    ...
    return (
        <div
            ref={cardRef}
            className={`service-card ${service.span} relative overflow-hidden rounded-2xl border border-stone-800 bg-black p-6 group cursor-pointer ${isVisible ? 'animate-slide-up' : 'opacity-0'
                }`}
            style={{
                minHeight: '180px',
                animationDelay: `${index * 100}ms`
            ...
            <div className="relative z-10 h-full flex flex-col justify-between ">
                <div className="flex justify-between items-start">
                    ...
                    <div className="p-2 bg-stone-800/50 rounded-lg border border-stone-700 group-hover:border-red-500/30 group-hover:scale-110 transition-all duration-300">
                        {Icon && <Icon className="w-5 h-5 text-stone-400 group-hover:text-red-400 group-hover:rotate-12 transition-all duration-300" />}
                    </div>
                </div>
        ...
        <div className="relative bg-black min-h-screen py-20 overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-5xl md:text-6xl font-light text-white mb-6 animate-fade-in" style={{ animationDelay: '200ms' }}>
                        Our{' '}
                        <span className="bg-gradient-to-r from-red-500 to-red-600 bg-clip-text font-normal text-red-900 text-transparent">
                            Services
                        </span>
                    </h2>
                    <p className="text-stone-400 text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '400ms' }}>
