...
import { ArrowRight, Twitter, Linkedin, Plus } from 'lucide-react';
...
const App: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10 p-4 sm:p-8 md:p-12 lg:p-20 flex flex-col min-h-screen">

                {/* Top Right Header */}
                <header className="flex justify-end mb-12">
                    <p className="max-w-xs text-right text-sm font-light leading-snug opacity-80 mt-10">
                        No noise, no templates — just thoughtful strategy, asymmetric precision, and a team that delivers.
                    </p>
                </header>
                ...
                <main className="flex-grow grid grid-cols-1 lg:grid-cols-3 gap-8 items-end">
                    ...
                    <div className="lg:col-span-2 flex flex-col justify-end">
                        ...
                        <div className="mt-20 flex flex-wrap gap-6">
                            ...
                            >
                                ...
                                <p className="text-sm font-semibold mb-3 opacity-90">services</p>
                            ...
                            {/* 120+ projects */}
                            <div
                                className="w-full sm:w-64 p-6 rounded-2xl border-2 border-white/20 backdrop-blur-sm bg-black/30 cursor-pointer transition-all duration-300 hover:bg-black/50"
                            >
                                <p className="text-4xl font-bold mb-2">120+</p>
                                <p className="text-sm font-semibold mb-3 opacity-90">projects</p>
                                <p className="text-xs font-light opacity-70">
                    ...
                    <div className="lg:col-span-1 flex flex-col items-end justify-end space-y-6">
                        ...
                        {/* Ad Budget Card */}
                        <div
                            className="w-full max-w-sm rounded-2xl p-6 bg-black/70 border border-red-500/50 backdrop-blur-md shadow-2xl transition-transform duration-300 hover:scale-[1.02] cursor-pointer"
                        >
                            ...
                            <div className="text-center">
                                <p className="text-3xl font-extrabold text-red-400">2K+ Automations</p>
                                ...
                                <div className="flex justify-center -space-x-2">
                                    {profiles.map((p) => (
                                        <ProfileAvatar key={p.id} name={p.name} className="hover:z-10 transition-all duration-300" />
                                    ))}
                                </div>
                            </div>
                        </div>
            ...
            <div
                className={`fixed bottom-0 left-1/2 transform -translate-x-1/2 p-3 px-6 bg-red-600 rounded-t-xl text-sm transition-opacity duration-300 z-50 ${feedback ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
            >
