...
const profileData: ProfileData = {
  ...
  company: "@Bricklix",
  avatar: "/Oan.jpeg" // Add your profile image path
};
...
export default function CTASection() {
  ...
  return (
    <section className="relative py-5 px-4 bg-gray-900 overflow-hidden ">
      ...
      <div className="relative z-10 max-w-6xl mx-auto p-12" >
        {/* Main Content Card */}
        <motion.div
