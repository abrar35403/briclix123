...
export default function PortfolioCarousel() {
    const cards = [
        { title: 'Project Alpha', src: "/p1.png" },
        { title: 'Brand Redesign', src: "/p2.jpg" },
        { title: 'E-commerce Launch', src: "/p3.jpg" },
        { title: 'Mobile App UI', src: "/p4.jpg" },
        { title: 'SaaS Platform', src: "/p5.jpg" },
        { title: 'Marketing Campaign', src: "/p6.png" },
    ];
